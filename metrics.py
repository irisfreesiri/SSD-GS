...
def evaluate(model_paths, data_set_path):
    ...
    for scene_dir in model_paths:
        try:
            ...
            model_dir = Path(scene_dir) / data_set_path
            print("Scene:", model_dir)
            ...
            with open(f"{scene_dir}/results_{data_set_path}.json", 'w') as fp:
                json.dump(full_dict[scene_dir], fp, indent=True)
            with open(f"{scene_dir}/per_view_{data_set_path}.json", 'w') as fp:
                json.dump(per_view_dict[scene_dir], fp, indent=True)
        except Exception as e:
            print(f"Unable to compute metrics for model: {model_dir}, exception: {e}")
